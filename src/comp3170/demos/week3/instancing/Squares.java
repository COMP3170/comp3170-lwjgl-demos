...
public class Squares {
	...
	public void draw() {
		...
		shader.setAttributeInstanced("a_worldPos", positionBuffer);
		shader.setAttributeInstanced("a_rotation", rotationBuffer);
		shader.setAttributeInstanced("a_scale", scaleBuffer);

		// write the colour value into the u_colour uniform
		shader.setAttributeInstanced("a_colour", colourBuffer);
