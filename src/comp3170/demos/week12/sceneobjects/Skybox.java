...
public class Skybox extends SceneObject {
	...
	private static final String[] TEXTURE_FILES = new String[] { "X.png", "X.png", "Y.png", "Y.png", "Z.png",
			"Z.png", };

	// https://opengameart.org/content/cloudy-skyboxes
	private static final String[] SKYBOX_TEXTURE_FILES = new String[] { "bluecloud_lf.jpg", "bluecloud_rt.jpg",
			"bluecloud_up.jpg", "bluecloud_dn.jpg", "bluecloud_ft.jpg", "bluecloud_bk.jpg", };
